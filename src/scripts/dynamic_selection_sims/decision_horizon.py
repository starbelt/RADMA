...
def run_all_case_studies():
    ...
    sso_crisis['solar_generation_mw'] = 300.0  
    sim_sso.run_case_study("SSO_02_Eclipse_Crisis", config_overrides=sso_crisis)
    
    # target rich hotspots generating huge time-limited burst demands
    burst_events = [
